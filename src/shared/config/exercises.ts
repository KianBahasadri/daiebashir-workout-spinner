...
export const EXERCISES: Exercise[] = [
    ...
    {
        name: "10 mins run",
        color: RARITY_CONFIG.common.color,
        rarity: "common",
        duration: 10,
        isExitCondition: false,
    },
    {
        name: "10 mins row (cardio)",
        color: RARITY_CONFIG.common.color,
        rarity: "common",
        duration: 10,
        isExitCondition: false,
    ...
    {
        name: "1 min pushups",
        color: RARITY_CONFIG.rare.color,
        rarity: "rare",
        duration: 1,
        isExitCondition: false,
    },
    ...
    {
        name: "10 mins squats",
        color: RARITY_CONFIG.epic.color,
        rarity: "epic",
        duration: 10,
        isExitCondition: false,
    },
    {
        name: "10 mins bench press",
        color: RARITY_CONFIG.epic.color,
        rarity: "epic",
        duration: 10,
        isExitCondition: false,
    ...
    {
        name: "Shawarma + Beer",
        color: RARITY_CONFIG.godly.color,
        rarity: "godly",
        duration: 0,
        isExitCondition: true,
    },
