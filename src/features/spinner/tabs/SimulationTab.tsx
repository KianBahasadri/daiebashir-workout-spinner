...
export function SimulationTab({
    ...
    const runSimulation = () => {
        ...
        setTimeout(() => {
            ...
            while (totalSpins < targetSpins) {
                ...
                lengthFrequencies[workoutLength] =
                    (lengthFrequencies[workoutLength] || 0) + 1;
            }

            const rarityStats: RarityStats[] = (
                Object.keys(RARITY_CONFIG) as (keyof typeof RARITY_CONFIG)[]
            ).map((rarity) => ({
                rarity,
            ...
            const variance =
                sumOfLengthsSquared / totalWorkouts - avgLength * avgLength;
    ...
    const histogramData = useMemo(() => {
        ...
        const lengths = Object.keys(freqs)
            .map(Number)
            .sort((a, b) => a - b);
        ...
        <div className="simulation-tab">
            <div className="math-card math-card--full">
                ...
                <p className="math-subtitle">
                    Run thousands of simulated spins to verify that the random
                    selection logic matches the theoretical mathematical model.
                </p>
                ...
                <div className="sim-controls">
                    <label>
                        ...
                        <select
                            value={targetSpins}
                            onChange={(e) =>
                                setTargetSpins(Number(e.target.value))
                            }
                    ...
                    <button
                        ...
                        disabled={
                            results?.isSimulating || exercises.length === 0
                        }
                    >
            ...
            {results && (
                <div className="sim-results">
                    <div className="math-card">
                        ...
                        <p className="math-subtitle">
                            Across all {results.totalSpins.toLocaleString()}{" "}
                            spins
                        </p>
                                        ...
                                        return (
                                            <tr key={stat.rarity}>
                                                <td
                                                    style={{
                                                        color: RARITY_CONFIG[
                                                            stat.rarity as keyof typeof RARITY_CONFIG
                                                        ].color,
                                                        fontWeight: "bold",
                                                    }}
                                                >
                    ...
                    <div className="math-card">
                        ...
                        <p className="math-subtitle">
                            Across {results.totalWorkouts.toLocaleString()} full
                            workouts
                        </p>
                        <div className="sim-kpi-group">
                            ...
                            <div className="sim-kpi">
                                ...
                                <span
                                    className="sim-kpi-value"
                                    style={{
                                        color:
                                            Math.abs(
                                                results.avgLength -
                                                    math.expectedSpinsUntilEnd,
                                            ) > 0.5
                                                ? "#ff4d4f"
                                                : "#52c41a",
                                    }}
                        ...
                        <div className="sim-chart">
                            {results.rarityStats.map((stat) => {
                                ...
                                const maxVal = Math.max(
                                    ...results.rarityStats.map((s) =>
                                        Math.max(s.expected, s.actual),
                                    ),
                                );
                    ...
                    <div className="math-card math-card--full">
                        ...
                        <p className="math-subtitle">
                            ...
                            The most frequent result is 1 spin, with a long tail
                            for longer workouts. The{" "}
                            <span
                                style={{
                            ...
                            shows the theoretical mathematical model.
                        </p>
                        {(() => {
                            const chartW = 800;
                            const chartH = 260;
                            ...
                            const barWidth =
                                displayMax > 0
                                    ? Math.max(1, (innerW / displayMax) * 0.8)
                                    : 0;
                            const barGap =
                                displayMax > 0
                                    ? (innerW / displayMax) * 0.2
                                    : 0;
                            ...
                            for (let i = 0; i <= yAxisTicks; i++) {
                                ...
                                const y =
                                    pad + innerH - (val / safeMax) * innerH;
                                yAxisLabels.push({ value: val, y });
                            }

                            const polylinePoints = histogramData
                                .map((d, i) => {
                                    const t = (i + 0.5) / displayMax;
                                    const x = pad + t * innerW;
                                    const p = math.exitProbability;
                                    const theoreticalProb =
                                        Math.pow(1 - p, d.length - 1) * p;
                                    const theoreticalCount =
                                        theoreticalProb * results.totalWorkouts;
                                    const y =
                                        pad +
                                        innerH -
                                        (theoreticalCount / safeMax) * innerH;
                            ...
                            return (
                                <div
                                    className="sim-histogram-wrapper"
                                    style={{
